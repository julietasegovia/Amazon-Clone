...
function Header() {
  return (
    <div className='bg-gray-900 w-full h-16 flex justify-around items-center'>
        <img src="https://www.pngmart.com/files/23/Amazon-Logo-White-PNG-Image.png" className='mt-2 h-10'/>
        ...
        <div className='flex gap-10'>
            <div className='flex flex-col justify-center cursor-pointer'>
                <span className='text-gray-100 text-xs'>Hello</span>
            ...
            <div className='relative cursor-pointer w-9 h-9'>
                ...
                <span className='absolute top-1 left-4 text-orange-400 font-bold'>0</span>
            </div>
        </div>
    </div>
  )
